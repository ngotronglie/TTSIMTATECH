                    ...
                    <div class="auth-buttons d-flex align-items-center">
                        ...
                        <div class="notification-icon">
                            <button class="btn btn-link" data-toggle="dropdown">
                                <i class="fa fa-bell"></i> <!-- Sử dụng Font Awesome cho icon chuông -->
                                <span class="badge badge-danger" id="notification-count">0</span> <!-- Số lượng thông báo mới -->
                            </button>
                            <div class="dropdown-menu" id="notification-list" style="min-width: 250px;">
